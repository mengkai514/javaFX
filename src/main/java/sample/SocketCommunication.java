...
//    public SocketCommunication(JSONObject objectMessage){
//        // 服务端IP地址
//        String HOST = "192.168.3.100";
//        // 服务端端口
//        int PORT = 50001;
...
//                System.out.println("连接成功");
//                ClientSend clientSend = new ClientSend(socket);
//                clientSend.setMsg(objectMessage);
//                new Thread(clientSend).start();
//                ClientReceive clientReceive = new ClientReceive(socket);
//                clientReceive.start();
//                while (clientReceive.res == null){
...
//    }
    ...
    public JSONObject communite(String content){
...
//             解析成对象
    ...
    public JSONObject communite(Object content){
...
//    public void setMsg(JSONObject message) {
